                ...
                <div class="list-group">
                    @foreach ( $activity as $item )
                        @if( $item->table == 'posts' )
                            <?php
                                $icon = 'fa-pencil';
                                $post = ComposeDe\Blogify\Models\Post::withTrashed()->find($item->row);
                            ?>
                        ...
                        @if ( $item->table == 'comments' )
                                <?php
                                    $icon = 'fa-comments';
                                    $author = ComposeDe\Blogify\Models\Comment::withTrashed()->find($item->row)->user->fullName;
                                ?>
                        ...
                        @if ( $item->table == 'categories' )
                                <?php
                                    $icon = 'fa-th-large';
                                    $category = ComposeDe\Blogify\Models\Category::withTrashed()->find($item->row);
                                ?>
                        ...
                        @if ( $item->table == 'tags' )
                                <?php
                                    $icon = 'fa-tags';
                                    $tag = ComposeDe\Blogify\Models\Tag::withTrashed()->find($item->row)
                                ?>
